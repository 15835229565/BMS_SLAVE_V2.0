...
REM @SET CALIBRATECODE="c:\Documents and Settings\Owner\My Documents\bms_slave_studio6\AtTiny_programmer\rc_calib.hex"
@SET CALIBRATECODE="c:\Documents and Settings\Owner\My Documents\bms slave_from_tadej\rc_calib.hex"

%TOOL% -cUSB -I125000 -d%CPU% -s -e -pf -if%CALIBRATECODE%
@REM %TOOL% -cUSB -I125000 -d%CPU% -s -f%CAL_FUSES% -e -pf -if%CALIBRATECODE%
