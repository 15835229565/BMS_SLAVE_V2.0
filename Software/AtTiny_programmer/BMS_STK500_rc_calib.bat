...
@SET CALIBRATECODE="rc_calib_STK500.hex"


%TOOL% -cCOM3 -I125000 -d%CPU% -s -f%CAL_FUSES% -e -pf -if%CALIBRATECODE%
...
%TOOL% -cCOM3 -I125000 -d%CPU% -ae0,0 -ve -ie0xFF_byte.hex
...
@REm %TOOL% -cCOM3 -I125000 -d%CPU% -e -pf -vf -if%CUSTOMERCODE% -Z0 -Sf0x01FF
%TOOL% -cCOM3 -I125000 -d%CPU% -e -pf -vf -if%CUSTOMERCODE% -Z0 -Se00
